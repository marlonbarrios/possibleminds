...
![PXL_20251029_201201167](https://github.com/user-attachments/assets/f05be8db-77d2-4581-9277-95db8ef94ed2)  
*Interactive prototype testing at the University of Florida’s Innovation Showcase.*
...
- **Aaron Sloman’s** notion of a *space of possible minds*, which opens the question of intelligence across species, machines, and future architectures.  
- **Donna Haraway’s** *Cyborg Manifesto* and her *tentacular thinking*, which dissolve rigid boundaries between human and nonhuman, natural and artificial, proposing *sympoiesis*—making-with—as an ethical and epistemic framework. Her call for *situated knowledges* grounds my work: every cognitive assembly becomes a local act of knowing and becoming-with.  
- **N. Katherine Hayles’s** *posthuman* perspective, which situates cognition as a distributed and hybrid process embedded in networks of humans and machines.  
- **The enactivist tradition** of **Francisco Varela**, **Evan Thompson**, and **Alva Noë**, who describe cognition as embodied sense-making through active coupling with the environment.  
- **Karl Friston’s** *Free Energy Principle* and *Active Inference* framework, which suggest that all self-organizing systems maintain themselves by predicting and minimizing surprise—mind as a living model of the world.  
- **Andy Clark’s** *predictive processing* and *extended mind* theories, which frame the brain as an anticipatory system whose cognitive reach extends into bodies, environments, and technologies.  
- **Blaise Agüera y Arcas** and **Michael Levin**, whose research on synthetic and morphogenetic intelligence challenges human-centered definitions of cognition.  
- **Peter Godfrey-Smith’s** reflections on octopus intelligence, where thought becomes decentralized, tactile, and fluid. This *distributed mind* inspires the tentacular forms that inhabit the installation, a metaphor resonant with Haraway’s call for *tentacular thinking*—the weaving of thought through touch, relation, and interdependence.
